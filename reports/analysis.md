...
|---|---|---|---|---|---|---|
| 2024 | 165 | 37.415 | 49.8% | 166 | 0.589 | 1.156 |
| 2025 | 81 | 16.071 | 32.3% | 170 | 0.583 | 0.847 |
| 2026 | 113 | 21.606 | 33.5% | 224 | 0.765 | 1.131 |

The composition of the area's extreme PSAT right tail changes materially. TJHSST's share of NMSFs in the balanced public panel falls from **49.8% in 2024** to **32.3% in 2025** and **33.5% in 2026**. That is strong descriptive evidence of **deconcentration away from TJHSST**.

Base-school gains are delayed and incomplete. The balanced conventional-public rate is nearly flat from 2024 to 2025 (0.589 to 0.583 per 100 juniors), then rises to 0.765 in 2026. The increase is heterogeneous across schools and pathways rather than a uniform zone-wide shift.
...
That 65.0% figure is the most generous accounting view because it does not adjust for enrollment growth. Holding each group's 2023-2024 rate constant at its actual 2025-2026 enrollment yields a TJHSST shortfall of **144.2** and a base-school excess of **53.7**, so the standardized offset is only **37.3%**. Using TJHSST's full 2019-2024 baseline gives **36.3%**. The component-standardized balanced public panel remains roughly **90.4 NMSFs below** its baseline-rate expectation.
...
The composition of that public right tail changes sharply even where the combined rate nearly recovers: TJHSST's share of balanced public NMSFs falls from **49.8% in 2024** to **32.3% in 2025** and **33.5% in 2026**. The clearest supported conclusion is therefore deconcentration of exceptional PSAT outcomes away from TJHSST, not a demonstrated decline in the whole region's academic culture.

This local near-recovery does not mean the regional right tail fully recovered relative to Virginia. Using source-backed statewide totals for 2024 and 2026 plus a secondary fallback for the unresolved Class 2025 total, the balanced public panel's share is approximately **70.4% in 2024, 63.7% in 2025, and 68.2% in 2026**. TJHSST's own share falls from **35.1% to 20.6% to 22.9%**.[^findings_state] The 2026 statewide denominator is provisional pending reconciliation against the NMSC guide total, so this caveat affects statewide-share interpretation but not local school counts.
...
- Canonical panel SHA-256: `85a6a22b7ccaa86d2ca42b126039c0ef287a755a4b8e45c6878b5846c784073f`
