...
LCPS Class 2026, a total-only official LCPS Class 2025 release, and two
Class 2025 Fairfax-area private-school rows from a local Patch article. APS/LCPS
...
no-school-attribution rule. Overlapping public-school rows in the Patch article
are retained only in the source snapshot because official FCPS rows already
