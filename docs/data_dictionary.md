...
- Statewide semifinalist total fields are source-backed for Classes 2023, 2024, and 2026 from complete Virginia list snapshots and blank with `statewide_nmsf_semifinalist_total_status=not_sourced` for other years. The Class 2026 supplied-list snapshot currently totals 494, while the public NMSC 2026 guide cross-check lists Virginia at 489; statewide-share metrics should be treated as provisional until that denominator discrepancy is reconciled.
